...
//print values
  ...
  //thats for 1. make secured GET request
...
/*uhhh its gonna be Temperature - t ... kinda weird*/
    ...
    /*prev*/
   //float display = libHumidity - Humidity;
  //display = 15!
...
//send more values to initial state: 
...
/*end of sending to initial state*/
  ...
  delay(120000);
  //delay for HTTPS request.... eerm hopefully it will not break PLSSSS
